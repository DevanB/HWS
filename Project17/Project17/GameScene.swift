...
//  Project17
//
//  Created by Devan Beitel on 9/12/16.
...
class GameScene: SKScene {
    ...
    var livesImages: [SKSpriteNode] = [SKSpriteNode]()
    var lives: Int = 3
    var activeSliceBG: SKShapeNode!
    var activeSliceFG: SKShapeNode!
    var activeSlicePoints: [CGPoint] = [CGPoint]()
    var isSwooshSoundActive: Bool = false
    var activeEnemies = [SKSpriteNode]()
    var bombSoundEffect: AVAudioPlayer!
    var popupTime: Double = 0.9
    var sequence: [SequenceType]!
    var sequencePosition: Int = 0
    var chainDelay: Double = 3.0
    var nextSequenceQueued: Bool = true
